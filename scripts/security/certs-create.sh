...
#
users=(kafka1 kafka2 kafka3 client schemaregistry restproxy connect connectorSA controlCenterAndKsqlDBServer ksqlDBUser appSA badapp clientListen zookeeper mds)
