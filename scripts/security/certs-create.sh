...
users=(kafka1 kafka2 client schemaregistry restproxy connect connectorSA control-center ksqlDBserver ksqlDBUser appSA badapp clientListen zookeeper mds)
