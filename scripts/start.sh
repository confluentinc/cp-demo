...
if [[ "$C3_KSQLDB_HTTPS" == "false" ]]; then
  export CONTROL_CENTER_KSQL_WIKIPEDIA_URL=${CONTROL_CENTER_KSQL_WIKIPEDIA_URL:-http://ksqldb-server:8088}
  export CONTROL_CENTER_KSQL_WIKIPEDIA_ADVERTISED_URL=${CONTROL_CENTER_KSQL_WIKIPEDIA_ADVERTISED_URL:-http://localhost:8088}
  C3_URL=http://localhost:9021
else
  export CONTROL_CENTER_KSQL_WIKIPEDIA_URL=${CONTROL_CENTER_KSQL_WIKIPEDIA_URL:-https://ksqldb-server:8089}
  export CONTROL_CENTER_KSQL_WIKIPEDIA_ADVERTISED_URL=${CONTROL_CENTER_KSQL_WIKIPEDIA_ADVERTISED_URL:-https://localhost:8089}
